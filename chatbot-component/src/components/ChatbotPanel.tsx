            ...
            <>
              ...
              {isLoading && (
                <div className="flex justify-start mb-4">
                  <div className="px-4 py-3 bg-light-blue border border-primary-blue">
                    <div className="flex gap-2">
                      <div className="w-2 h-2 bg-primary-blue rounded-full animate-pulse" />
                      <div className="w-2 h-2 bg-primary-blue rounded-full animate-pulse delay-100" />
                      <div className="w-2 h-2 bg-primary-blue rounded-full animate-pulse delay-200" />
                    </div>
                  </div>
                </div>
              )}
